...
class ParentsMeetingFragment() : Fragment() {
    ...
    var mListViewStaffArray: ArrayList<StaffModel>? = null
    ...
    private fun initialiseUI() {
        ...
        studentNameTV = requireView().findViewById(R.id.studentNameTV)
        staffNameTV = requireView().findViewById(R.id.staffNameTV)
        selectStaffImgView = requireView().findViewById(R.id.selectStaffImgView)
        next = requireView().findViewById(R.id.next)
        contactTeacher = requireView().findViewById(R.id.contactTeacher)
        selectStudentImgView = requireView().findViewById(R.id.selectStudentImgView)
        studentRelative = requireView().findViewById(R.id.studentRelative)
        ...
        reviewImageView = requireView().findViewById(R.id.reviewImageView)
